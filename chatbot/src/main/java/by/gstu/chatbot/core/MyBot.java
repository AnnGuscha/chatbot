...
public class MyBot implements Bot{
    ...
    // default constructor
    public MyBot(String level, DataParser parser) {
    ...
    public String getMessage() {
        ...
        String response = replaceMatches(state.getMessage()).trim();
        //response = DataBaseService.fillResponse(response);
        return response;
    }
    ...
    public String send(String message) {
        ...
        if (match == null || match.target.length()<1) {
...
//                }
    ...
    public String getAnswer(String question){
        ...
        String answer = this.send(question);
