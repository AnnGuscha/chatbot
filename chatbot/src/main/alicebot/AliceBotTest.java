...
import by.gstu.chatbot.alicebot.aiml.Category;
import by.gstu.chatbot.alicebot.text.Request;
import by.gstu.chatbot.alicebot.text.Response;
import by.gstu.chatbot.alicebot.text.Sentence;

import static by.gstu.chatbot.alicebot.text.TransformationsTest.assertRequest;
import static by.gstu.chatbot.alicebot.text.TransformationsTest.assertSentence;
...
public class AliceBotTest extends TestCase
{
  ...
  */
  ...
  public void testSrai()
  {
    ...
    assertEquals("Once more? \"that\".", bot.respond("You may say that again, alicebot."));
  }
