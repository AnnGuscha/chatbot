...
public class SentenceSplitterTest extends TestCase
{
  ...
  */
  ...
  {
    String[] expected = 
      {"Hello alicebot.", "How are you?", "You look fine!", "Please forgive my manners;", "I am so happy today..."};

    String input = "Hello alicebot. How are you? You look fine! Please forgive my manners; I am so happy today...";
