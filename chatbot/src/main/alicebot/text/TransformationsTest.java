...
package by.gstu.chatbot.alicebot.text;
...
public class TransformationsTest extends TestCase
{
  ...
  */
  ...
  {
    Request expected =
      new Request(" Hello alicebot. How are you? You look fine! Please forgive my manners; I am so happy today... ",
                  new Sentence(" Hello alicebot. ", new Integer[] {0, 6, 13}, " HELLO ALICE "),
  ...
  public void testNormalizeSentence()
  {
    ...
    assertSentence(" Hello alicebot. ", new Integer[] {0, 6, 13}, " HELLO ALICE ");
