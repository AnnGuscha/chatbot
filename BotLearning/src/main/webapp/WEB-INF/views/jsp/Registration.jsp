...
<div class="container">
    ...
    <form action="/registr" method=post role="form" data-toggle="validator">
        <div class="form-group col-xs-4">
            <label for="login" class="control-label col-xs-4"><fmt:message bundle="${loc}" key="label.login"/>:</label>
            <input type="text" name="login" id="login" class="form-control" value=""
                   required="true"/>
            <br/>
            <label for="password" class="control-label col-xs-4"><fmt:message bundle="${loc}" key="label.password"/>:</label>
            <input type="text" name="password" id="password" class="form-control" value=""
                   required="true"/>
            <br/>
            <label for="locale" class="control-label col-xs-4"><fmt:message bundle="${loc}" key="label.locale"/>:</label>
